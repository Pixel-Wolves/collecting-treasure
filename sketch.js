...
function setup(){
  ...
  mainCyclist.setCollider("rectangle", 0,0,750,750);
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if (World.frameCount % 150 == 0) {
      ...
      if(obstacles.isTouching(mainCyclist)){
        gameState = END;
      }
  }
    ...
    text("Press UP to restart", 550, 200);
...
function createObstacles(){
  var obstacle = createSprite(1100, round(random(50,250)));
  var obstacleImg = loadImage("images/obstacle1.png");
